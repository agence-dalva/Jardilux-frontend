    ...
    <div className="min-h-screen bg-[#faf7f2]">
      ...
      <div className="relative bg-[#0E0D06] overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/services/service-1.jpg" alt="" className="w-full h-full object-cover opacity-35" />
        </div>
        <div className="relative max-w-[1280px] mx-auto px-6 pt-16 pb-24 text-center">
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#DCA54A] mb-4 inline-block">Ce que nous proposons</span>
            ...
            <h1 className="font-playfair text-5xl md:text-6xl font-bold text-white mb-5 leading-tight">
              Services pour embellir
              <br />
              votre extérieur
            </h1>
            <p className="text-white/65 text-lg max-w-xl mx-auto leading-relaxed">
              De la sélection des produits à l'installation, Jardilux vous accompagne dans chaque étape de votre projet extérieur.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="mb-16">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#DCA54A] mb-4 inline-block">Notre gamme</span>
            <GoldDivider className="mb-5" />
            <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#1a1a1a]">Nos catégories de produits</h2>
            <p className="text-[#5a5a5a] mt-3 max-w-xl">Une gamme complète pour tous vos besoins en aménagement extérieur.</p>
          </div>
              ...
              >
                <div className={i % 2 === 1 ? 'lg:order-2' : ''}>
                  <div className="flex items-center gap-3 mb-5">
                    <span className="font-playfair text-4xl font-bold text-[#e8dcc8] leading-none select-none">{svc.num}</span>
      ...
      <section className="py-20 bg-[#faf7f2]">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="mb-14">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#DCA54A] mb-4 inline-block">Comment ça se passe</span>
            <GoldDivider className="mb-5" />
            <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#1a1a1a]">Notre processus</h2>
          </div>
      ...
      <section className="py-20 bg-[#0E0D06] relative overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/banner-cta.jpg" alt="" className="w-full h-full object-cover opacity-40" style={{ objectPosition: 'center 45%' }} />
        </div>
        <div className="relative max-w-[1280px] mx-auto px-6 text-center">
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#DCA54A] mb-4 inline-block">Parlons de votre projet</span>
          <GoldDivider className="mb-5 mx-auto" />
          <h2 className="font-playfair text-4xl font-bold text-white mb-5">Un projet en tête ?</h2>
          <p className="text-white/60 mb-10 max-w-md mx-auto">Contactez-nous pour obtenir un devis personnalisé et des conseils d'experts.</p>
          <LuxuryButton href="/contact">Obtenir un devis gratuit</LuxuryButton>
        </div>
      </section>
    </div>
  );
